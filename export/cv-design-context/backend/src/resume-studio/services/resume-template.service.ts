...
export class ResumeTemplateService {
  ...
  private buildAiCodeGenerationInstructions(): string {
    return [
      ...
      'Use only these top-level CV sections when needed: personal, summary, experience, education, skills, skillProficiencies, projects, languages, certifications, additionalInformation, references.',
      'Exact personal placeholders: personal.fullName, personal.jobTitle, personal.email, personal.phone, personal.location, personal.website, personal.linkedin, personal.github, personal.photoUrl, personal.drivingLicense, personal.availability.',
      ...
      'Inside {{#each skillProficiencies}} use: name, proficiency.',
      ...
      'skills, personal.drivingLicense, and additionalInformation are arrays of strings; summary is a string.',
      ...
      'For current experience/education/projects, use isCurrent to render Present/Ongoing and do not duplicate endDate. For certifications with doesNotExpire, do not render an expiry date.',
